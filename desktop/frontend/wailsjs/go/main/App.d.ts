...
export function ListImages():Promise<Array<discovery.DockerImage>>;

export function ListLanguagePackages(arg1:string):Promise<Array<string>>;

export function ListNetworks():Promise<Array<discovery.DockerNetwork>>;
...
export function ListVolumes():Promise<Array<discovery.DockerVolume>>;
...
export function RemoveContainer(arg1:string,arg2:string):Promise<void>;
...
export function RemoveNetwork(arg1:string,arg2:string):Promise<void>;
...
export function RemoveVolume(arg1:string,arg2:string):Promise<void>;
